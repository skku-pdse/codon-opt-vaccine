...
def count_exclusion_motifs(sequence, exclusion_motifs):
    ...
    Returns:
        tuple of 12 elements (counts, motif strings, 1-based locations) for
        in-frame, out-frame, +1 frame, and +2 frame categories.
    """
...
# Regulatory motifs that are avoided during sequence design.
# Splice donor/acceptor signals (CAGG, AAGGTAAGT, etc.), TATA box (TATAAA),
# and additional splice-related elements (GGCCAATCT, GGTCAATCT).
exclusion_motifs = [
    'CAGG',
    'AAGGTAAGT',
    'AAGGTGAGT',
...
# --- Write output ---
output_file = 'Exclusion_analysis.tsv'
